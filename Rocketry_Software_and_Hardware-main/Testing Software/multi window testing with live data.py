...
# Function to display real-time graphs in the frame (Task 1)
def update_graph(canvas, ax, x_data, y_data):
    ...
    canvas.get_tk_widget().after(1000, update_graph, canvas, ax, x_data, y_data)
...
def display_dashboard(frame):
    ...
    update_graph(canvas, ax, x_data, y_data)
